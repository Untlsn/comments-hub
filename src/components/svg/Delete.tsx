...
const Delete = (props: JSX.SvgSVGAttributes<SVGSVGElement>) => {
  return (
    <svg width='1em' height='1em' fill="currentColor" viewBox='0 0 12 14' xmlns="http://www.w3.org/2000/svg" {...props}>
